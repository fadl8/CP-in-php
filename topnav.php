            ...
            <ul class="nav navbar-nav">
                ...
                <li class="nav-item">
                    <a href="index.php" class="navbar-brand nav-link">
                        <img alt="branding logo" src="../../assets/images/logo/big-loge.png"
                             data-expand="../../assets/images/logo/big-loge.png"
                             data-collapse="../../assets/images/logo/loge-smail.png"
                             class="brand-logo">
                    </a>
                </li>
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            ...
                            <li class="list-group scrollable-container">
                                ...
                                <a href="javascript:void(0)" class="list-group-item">
                                    <div class="media">
                                        <div class="media-left valign-middle">
                                            <i class="icon-monitor3 icon-bg-circle bg-red bg-darken-1"></i></div>
                                        <div class="media-body">
                            ...
                            <li class="dropdown-menu-footer">
                                <a href="javascript:void(0)" class="dropdown-item text-muted text-xs-center">Read all notifications</a></li>
                        </ul>

                        <!--
                             the end  ul for notifications
                             done by F8
                             -->
                    </li>

                    <!--
                       this li for Messages
                       done by F8
                       -->

                    <!--
                       the end of  li for Messages
                       done by F8
                       -->

                    <!--
                      this for profile in the web
                      done by F8
                      -->
                    <li class="dropdown dropdown-user nav-item">
                        <a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link">
                      <span class="avatar avatar-online">
                          <img src="../../assets/images/portrait/small/avatar-s-1.png" alt="avatar"><i>

                      </i></span><span class="user-name">ماجد الباعري</span>
                        </a>
